...
import { BeforeCreate, BeforeSave, Column, DefaultScope, ForeignKey, Model, Table } from "sequelize-typescript";
import { generateHash, uuid } from "src/config/core.helper";
